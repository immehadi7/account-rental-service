...
const FAQ = [
  {
    q: '如何租用账号？',
    a: '在首页选择账号 → 点击"立即租用" → 选择时长 → 支付宝/微信付款 → 联系客服获取账号。',
  },
  {
    q: '支持哪些支付方式？',
    a: '目前支持支付宝和微信支付，付款后请截图发给客服核验。',
  },
  {
    q: '租用后可以退款吗？',
    a: '租用前取消可全额退款。租用开始后如有问题，平台担保处理，支持全额退款。',
  },
  {
    q: '账号安全吗？',
    a: '所有账号均经过实名认证，平台担保交付。严禁修改密码或绑定支付方式。',
  },
  {
    q: '如何联系人工客服？',
    a: '可在聊天窗口直接发消息，或通过微信 zuhao_kefu / QQ 8888-0001 联系我们。',
  },
]
...
export default function SupportPage() {
  ...
  const handleTyping = () => {
    if (socketRef.current) {
      socketRef.current.emit('chat:typing', { username: user?.username })
    }
  }
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      {tab === 'chat' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {/* Chat window */}
          <div className="md:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col" style={{ height: '600px' }}>
            ...
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 text-xs">
                    <span className={`w-1.5 h-1.5 rounded-full ${connected ? 'bg-green-500 status-pulse' : 'bg-gray-400'}`} />
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-400">平均响应 36秒</span>
              </div>
            </div>
            ...
            <div className="px-4 py-3 border-t border-gray-100 flex gap-2 bg-white">
              <input
                ...
                className="flex-1 border border-gray-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-brand transition-colors"
              />
              <button
                onClick={() => sendMessage()}
      ...
      {tab === 'faq' && (
        <div className="max-w-3xl">
          ...
          <div className="mt-6 bg-brand-light border border-red-100 rounded-2xl p-5 text-center">
...
// Quote widget inside support page
